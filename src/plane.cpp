...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800,600,"plane",NULL,NULL);
    if (window == NULL)
    {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(horizontal_triangle), horizontal_triangle, GL_STATIC_DRAW);
